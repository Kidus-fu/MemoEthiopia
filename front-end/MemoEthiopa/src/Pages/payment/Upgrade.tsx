...
const Upgrade: React.FC = () => {
    ...
    return (
        <>
            <section className={getClassNames("py-4 h-screen overflow-auto ")}
            style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
            >
                <Link to={'/feed'}>
                <div className="fixed right-3 text-end cursor-pointer">
                    <CloseOutlined />
                </div>
                </Link>
                ...
                <div className={getClassNames("container px-4 mx-auto z-50")}>
                    <div className={getClassNames("max-w-2xl mx-auto mb-16 text-center")}>
                        ...
                        <h2 className={getClassNames("text-2xl font-bold lg:text-5xl")}>Choose your best plan</h2>
                    ...
                    <div className={getClassNames(" flex flex-wrap items-stretch -mx-4 z-50")}>
                        <div className={getClassNames(`flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 border  ${theme === 'dark' ? 'border-gray-700 shadow-[rgb(30,27,51)]' : ' border-gray-300'} shadow-2xl`)}>
                            <div className={getClassNames("flex flex-grow flex-col p-6 space-y-6 rounded  sm:p-8")}>
                                ...
                                <p className={getClassNames("mt-3 leading-relaxed")}>Perfect for students and casual users just getting started.</p>
                                <ul className={getClassNames("flex-1 mb-6")}>
                                ...
                                <button type="button" className={getClassNames(`inline-block ${user.paln === "Free" ? "opacity-15 cursor-not-allowed":""} px-5 py-3 font-semibold tracking-wider text-center rounded bg-[rgb(83,56,231)] text-white`)}>{user.paln === "Free" ? "Your current plan":"Get Started"}</button>
                            </div>
                        </div>
                        <div className={getClassNames(`flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 border  ${theme === 'dark' ? 'border-gray-700 shadow-[rgb(30,27,51)]' : ' border-gray-300'} scale-110 shadow-2xl `)}>
                            <div className={getClassNames("flex flex-grow flex-col p-6 space-y-6 rounded sm:p-8")}>
                                ...
                                <p className="leading-relaxed">or professionals who need more power and flexibility.</p>
                                ...
                                <a rel="noopener noreferrer" href="#" className={getClassNames(`inline-block ${user.paln === "Pro" ? "opacity-15 cursor-not-allowed":""} w-full px-5 py-3 font-bold tracking-wider text-center rounded  dark:bg-violet-600 text-white`)}>{user.paln === "Pro" ? "Your current plan":"Get Started"}</a>
                            </div>
                        </div>
                        <div className={getClassNames(`flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0 border  ${theme === 'dark' ? 'border-gray-700 shadow-[rgb(30,27,51)]' : ' border-gray-300'}   shadow-2xl`)}>
                            <div className={getClassNames("flex flex-grow flex-col p-6 space-y-6 rounded  sm:p-8")}>
                                ...
                                <p className={getClassNames("leading-relaxed ")}>For schools, teams, or businesses that need collaboration and more.</p>
                                <ul className={getClassNames("space-y-2 ")}>
