                                ...
                                <li className={getClassNames("flex")}>
                                    <div className={getClassNames("flex h-10 w-10 items-center justify-center rounded bg-blue-900")}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            ...
                                            stroke-linejoin="round" className="h-6 w-6 bg-transparent text-white">
                                    ...
                                    <div className={getClassNames("ml-4 mb-4")}>
                                        <h3 className={getClassNames("mb-2 text-lg font-medium leading-6 ")}>Our Address
                                        </h3>
                                        <p className={getClassNames("")}>1230 Maecenas Street Donec Road</p>
                                        <p className={getClassNames("")}>New York, EEUU</p>
                                    </div>
                                </li>
                                <li className={getClassNames("flex")}>
                                    <div className={getClassNames("flex h-10 w-10 items-center justify-center rounded bg-blue-900 ")}>
                                    ...
                                    <div className={getClassNames("ml-4 mb-4")}>
                                        <h3 className={getClassNames("mb-2 text-lg font-medium leading-6")}>Contact
                                        </h3>
                                        <p className={getClassNames("")}>Mobile: +1 (123) 456-7890</p>
                                        <p className={getClassNames("")}>Mail: tailnext@gmail.com</p>
                                    </div>
                                </li>
                                <li className="flex">
                                    <div className={getClassNames("flex h-10 w-10 items-center justify-center rounded bg-blue-900 ")}>
                                    ...
                                    <div className={getClassNames("ml-4 mb-4")}>
                                        <h3 className={getClassNames("mb-2 text-lg font-medium leading-6 ")}>Working
                                            hours</h3>
                                        <p className={getClassNames("")}>Monday - Friday: 08:00 - 17:00</p>
                                        <p className={getClassNames("")}>Saturday &amp; Sunday: 08:00 - 12:00</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
